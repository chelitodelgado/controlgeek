                    ...
                    <section class="login_content">
                        <form action="action/login.php" method="post">
                            ...
                            <div>
                                ...
                                <a class="reset_pass" href="registro.php">Crear cuenta nueva</a>
                            ...
                            <div class="separator">
                                ...
                                <div>
                                    ...
                                    <p> <a style="text-decoration: underline;" target="_blank" href="http://github.com/chelitodelgado">Soporte</a>is a Bootstrap 3 template. Privacy and Terms by <a target="_blank" style="text-decoration: underline;" href="https://github.com/chelitodelgado">Chelo.inc</a></p>
                                </div>
                            </div>
                        </form>
                    </section>
