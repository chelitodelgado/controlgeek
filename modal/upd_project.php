                    ...
                    <form class="form-horizontal form-label-left input_mask" method="post" id="upd" name="upd">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-9 col-sm-9 col-xs-12">
                              <input type="text" id="mod_name" required name="mod_name" class="form-control" placeholder="Materia">
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="control-label col-md-3 col-sm-3 col-xs-12">Docente <span class="required">*</span>
                            </label>
                            <div class="col-md-9 col-sm-9 col-xs-12">
